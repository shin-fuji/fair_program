...
/// <summary>
/// Data class to store only the most recent motion data frame, also provides methods to parse
/// the received motion data which is received as float values from the network.
/// "NeuronActor" also saves mocap info and provides methods to register callbacks when it was resumed or
/// suspended by NeuronSource.
/// </summary>
namespace Neuron
{
