...
/// <summary>
/// "NeuronSource" manages instances of NeuronActor with two dictionaries called "activeActors"
/// and "suspendedActors". "NeuronSource" monitors the lastest timestamp update inside
/// "NeuronActor" in the OnUpdate method and use a threshold to judge if any actor is lost
/// (number of actors in Axis Neuron has changed or the connection was lost completely). When
/// this happens, "NeuronSource" will add or remove actors between the two dictionaries and
/// notify "NeuronActor".
/// </summary>
namespace Neuron
{
