...
/// </summary>
public class RobotBehaviourScript_FairVer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // どの店の前にいるかを取得する
            NavMeshofCustomer_FairVer mode = GetComponent<NavMeshofCustomer_FairVer>();
    ...
    void OnTriggerStay(Collider collider)
    {
            ...
            whichBehavior == WALK)
        {
            ...
            {
                // 他客の行動変数の総和を取る
                i += customer.GetComponent<RobotBehaviourScript_FairVer>().whichBehavior;
