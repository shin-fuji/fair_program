...
/// </summary>
public class PlayerBehaviourText_FairVer : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider collider)
    {
        ...
        else if (collider.gameObject.tag == "Sec_Front_U")
        {
            //sw.WriteLine(RI);
            playerBehavList.Add(FRO_U);
            playerBehavList.Add(WALK.ToString());
            //Debug.Log("Enter RI");
        }
        else if (collider.gameObject.tag == "Sec_Front_M")
        {
            //sw.WriteLine(RI);
            playerBehavList.Add(FRO_M);
            playerBehavList.Add(WALK.ToString());
            //Debug.Log("Enter RI");
        }
        else if (collider.gameObject.tag == "Sec_Front_L")
        {
            //sw.WriteLine(RI);
            playerBehavList.Add(FRO_L);
            playerBehavList.Add(WALK.ToString());
            //Debug.Log("Enter RI");
        }
    }
