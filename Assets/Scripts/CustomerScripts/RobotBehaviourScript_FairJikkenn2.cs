...
/// </summary>
public class RobotBehaviourScript_FairJikkenn2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // どの店の前にいるかを取得する
            NavMeshofCustomer_FairJikkenn2 mode = GetComponent<NavMeshofCustomer_FairJikkenn2>();
    ...
    void OnTriggerStay(Collider collider)
    {
            ...
            whichBehavior == WALK)
        {
            ...
            {
                // 他客の行動変数の総和を取る
                i += customer.GetComponent<RobotBehaviourScript_FairJikkenn2>().whichBehavior;
